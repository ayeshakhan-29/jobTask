    ...
    return (
        <div id="contact" className="container mx-auto py-12 mt-16">
            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full md:w-1/2 mx-32 bg-[#181d22] px-10 py-10 rounded-lg " data-aos="fade-right" data-aos-duration="800">
                    ...
                    <form className="justify-center">
                        ...
                        <button type="submit" className="w-40 bg-[#76ABAE] hover:bg-black text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 ease-in-out  ">Send</button>
                    </form>
                </div>
